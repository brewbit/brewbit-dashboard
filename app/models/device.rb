...
# * output_1_name [string] - - Output 1 name
# * output_2_name [string] - - Output 2 name
# * sensor_1_name [string] - - Sensor 1 name
# * sensor_2_name [string] - - Sensor 2 name
...
class Device < ActiveRecord::Base
  ...
  validates :output_1_name, presence: true, length: { maximum: 100 }
  validates :output_2_name, presence: true, length: { maximum: 100 }
  validates :sensor_1_name, presence: true, length: { maximum: 100 }
  validates :sensor_2_name, presence: true, length: { maximum: 100 }
